...
<body>
    <div style="text-align: center; padding-top:200px" class="container">
        ...
        <h2>Вход</h2>
            ...
            <button class="btn btn w-25" style="background: #ff5319; color: white" type="submit">Вход</button><br> <br>
        </form>
        <a href="registr.php"><p class="lead t1">Вы не зарегистрированы? </p></a>
        <button class="btn w-25" style="background: #ff5319; color: white" onclick="window.location.href = 'index.php'" type="submit">Вернуться обратно</button><br>  
    </div>
</body>
</html>